...
import com.hndf.shop.dynamic.redis.method.RedisLimitMethod;
...
public @interface Cache {
    ...
    Class<? extends RedisOpsHandle> handleType() default RedisOpsStringHandle.class;
     ...
     */
    Class<? extends RedisLimitMethod> limitMethod() default RateLimitRedisMethod.class;

    Class<? extends RedisMethod> method() default DeafultRedisMethod.class;
